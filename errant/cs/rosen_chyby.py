...
pair_voiced_voiceless = list_to_dict(["b","p","B","P","d","t","D","T","ď","ť","Ď","Ť","g","k","G","K","z","s","Z","S","ž","š","Ž","Š","v","f","V","F","h","ch","H","Ch"])
pair_voiceless_voiced = list_to_dict(["p","b","P","B","t","d","T","D","ť","ď","Ť","Ď","k","g","K","G","s","z","S","Z","š","ž","Š","Ž","f","v","F","V","ch","h","Ch","H","CH","H"])

list_vocals = ["a","á","e","ě","é","i","é","o","ó","u","ú","ů","y","ý","A","Á","E","Ě","É","I","Í","O","Ó","U","Ů","Ú","Y","Ý"]
list_consonnants = ["b","B","c","C","č","Č","d","D","ď","Ď","f","F","g","G","h","H","ch","Ch","j","J","k","K","l","L","m","M","n","N","ň","Ň","p","P","q","Q","r","R","ř","Ř","s","S","š","Š","t","Ť","v","V","w","W","x","X","z","Z","ž","Ž"]
list_voiced = ["b","B","d","D","ď","Ď","g","G","v","V","z","Z","ž","Ž","h","H"]
list_voiceless = ["p","P","t","T","ť","Ť","k","K","s","S","š","Š","c","C","č","Č","f","F","ch","Ch"]

pair_shackem_bezhacku = list_to_dict(["č","c","Č","C","ď","d","Ď","D","ě","e","Ě","E","ľ","l","Ľ","L","ň","n","Ň","N","ř","r","Ř","R","š","s","Š","S","ť","t","Ť","T","ž","z","Ž","Z"])
pair_bezhacku_shackem = list_to_dict(["c","č","C","Č","d","ď","D","Ď","e","ě","E","Ě","l","ľ","L","Ľ","n","ň","N","Ň","r","ř","R","Ř","s","š","S","Š","t","ť","T","Ť","z","ž","Z","Ž"])
pair_detene = list_to_dict(["ďe","dě","ťe","tě","ňe","ně","ďi","di","ťi","ti","ňi","ni","ďí","dí","ťí","tí","ňí","ní","Ďe","Dě","Ťe","Tě","Ňe","Ně","Ďi","Di","Ťi","Ti","Ňi","Ni","Ďí","Dí","Ťí","Tí","Ňí","Ní"])
pair_palat = list_to_dict(["ke","ce","he","ze","ge","ze","che","še","kě","ce","hě","ze","gě","ze","chě","še","ki","ci","hi","zi","gi","zi","chi","ši","kí","cí","hí","zí","gí","zí","chí","ší"])
pair_long_short_vowel = list_to_dict(["á","a","Á","A","é","e","É","E","í","i","Í","I","ó","o","Ó","O","ů","u","Ů","U","ú","u","Ú","U","ý","y","Ý","Y"])
pair_lc_uc = list_to_dict(["a","A","á","Á","b","B","c","C","č","Č","d","D","ď","Ď","e","E","é","É","f","F","g","G","h","H","ch","Ch","i","I","í","Í","j","J","k","K","l","L","m","M","n","N","ň","Ň","o","O","ó","Ó","p","P","q","Q","r","R","ř","Ř","s","S","š","Š","t","T","ť","Ť","u","U","ú","Ú","ů","Ů","v","V","w","W","x","X","y","Y","ý","Ý","z","Z","ž","Ž"])

list_of_prefixes = ["arci","bez","beze","dia","do","ex","infra","mezi","místo","na","ná","nad","nade","ne","nej","o","ob","obe","od","ode","pa","para","po","pod","pode","popo","pra","proti","proto","pře","před","přede","přes","přese","při","pří","pseudo","roz","roze","s","se","sou","spolu","u","ú","v","ve","vele","vy","vý","vz","vze","z","za","zá","ze"]
list_of_prep_forms = ["během","bez","beze","blízko","dík","díky","dle","do","doprostřed","dovnitř","k","ke","kol","kolem","kontra","krom","kromě","ku","kvůli","mezi","mimo","místo","na","nad","nade","namísto","napospas","naproti","napříč","navzdory","nedaleko","o","ob","od","ode","ohledně","okolo","oproti","po","poblíž","pod","pode","podél","podle","pomocí","prostřednictvím","proti","před","přede","přes","přese","při","s","se","skrz","skrze","u","uprostřed","uvnitř","v","včetně","ve","vedle","versus","vně","vod","vstříc","vůči","vyjma","vzdor","z","za","ze","zevnitř","zkraje","zpod","zpoza"]
...
def compare_single_characters(w_char, a_char, w1_char,a1_char):
    ...
    if not report_error_char:
        ...
        #ý/i,í/y...
        elif ((w_char in ["y", "ý", "Y", "Ý"]) and (a_char in ["i", "í", "I", "Í"])) or ((w_char in ["i", "í", "I", "Í"]) and (a_char in ["y", "ý", "Y", "Ý"])):
            report_error_char='Y'
        ...
        if (report_error_char == 'Y') and (((w_char in ['I', 'Í', 'Y', 'Ý']) and (a_char in ['y', 'ý', 'i', 'í'])) or ((a_char in ['I', 'Í', 'Y', 'Ý']) and (w_char in ['y', 'ý', 'i', 'í']))):
...
# =======================================================================================================
        ...
        for id_ch in range(len(w_string)):
            if w_string[id_ch] == a_string[id_ch]:
                ...
                # Lokální metateze. "jesm"
                      ...
                      and ((id_ch+1==len(w_string) or ((id_ch < len(w_string) - 2) and (w_string[id_ch+2] == a_string[id_ch+2]))) and \
                    ...
                    and ((id_ch==len(w_string)) or ((id_ch < len(w_string) - 1) and(w_string[id_ch+1] == a_string[id_ch+1]))) and ((id_ch>0) and (w_string[id_ch-1] == a_string[id_ch-1])):
                    e_string[id_ch] = 'M'
                    errors.append('formMeta')
                    error_neurceno = 0
                    single_char_error = 0
                
                elif ((id_ch+1<len(w_string)) and (w_string[id_ch+1] == a_string[id_ch+1]) and ((id_ch==0) or (w_string[id_ch-1] == a_string[id_ch-1]))) : 
            ...
            for id_ch in range(0,  max(len(a_string), len(w_string))):
                ...
                if not e_string[id_ch]: # OK
                    ...
                    if (id_ch < len(w_string) - 1) and (id_cha < len(a_string) - 1):
                        ...
                        if (id_ch > 0) and (id_cha > 0) and (w_string[id_ch-1].lower() == "i") and (a_string[id_cha-1].lower() == "i") and \
                            (((w_string[id_ch].lower() == "j") and (w_string[id_ch + 1] in list_vocals) and (w_string[id_ch+1] == a_string[id_cha])) or \
                            ((a_string[id_cha].lower() == "j") and (a_string[id_cha+1] in list_vocals) and (w_string[id_ch] == a_string[id_cha+1]))):
                        ...
                        if (not e_string[id_ch]) and (id_ch==0) and (((w_string[0].lower() == "j") and (a_string[0].lower() != "j") and \
                            ((w_string[1] == a_string[0]) or (a_string[0].lower() == w_string[1].lower())) and (a_string[0] in list_consonnants)) or \
                            ((a_string[0].lower() == "j") and (w_string[0].lower() != "j") and \
                            ((w_string[0] == a_string[1]) or (w_string[0].lower() == a_string[1].lower())) and (a_string[1] in list_consonnants))):
                        ...
                        if (not e_string[id_ch]) and (id_ch==0) and (((w_string[0].lower() == "v") and (a_string[0].lower() != "v") and \
                            ((w_string[1] == a_string[0]) or (a_string[0].lower() == w_string[1].lower())) and (a_string[0].lower() == "o")) or \
                            ((a_string[0].lower() == "v") and (w_string[0].lower() != "v") and ((w_string[0] == a_string[1]) or \
                            (w_string[0].lower() == a_string[1].lower())) and (a_string[1].lower() == "o"))):
                            if (w_string[0].lower() == "j"):
                        ...
                        if (not e_string[id_ch]) and (w_string[id_ch] == 'e') and (id_ch > 0) and (a_string[id_cha-1] == w_string[id_ch-1]) and \
                            (a_string[id_cha] == w_string[id_ch+1]) and (w_string[id_ch-1] in list_consonnants) and (w_string[id_ch+1] in list_consonnants):
                        ...
                        elif (not e_string[id_ch]) and (a_string[id_cha] == 'e') and (id_cha > 0) and (a_string[id_cha-1] == w_string[id_ch-1]) and \
                            (a_string[id_cha+1] == w_string[id_ch]) and (w_string[id_ch-1] in list_consonnants) and (w_string[id_ch] in list_consonnants):
                        ...
                        if (id_ch > 0) and (id_cha > 0) and (w_string[id_ch].lower() != a_string[id_cha].lower()) and \
                            (w_string[id_ch-1].lower() == a_string[id_cha-1].lower()) and (((w_string[id_ch-1].lower() == w_string[id_ch].lower()) and \
                            (w_string[id_ch+1].lower() == a_string[id_cha].lower())) or ((a_string[id_cha-1].lower() == a_string[id_cha].lower()) and \
    ...
    if len(errors) == 0:
        ...
        if (a_string[0] == w_string[0]) or \
            ((len(a_string)>2) and (len(w_string)>2) and (a_string[1] == w_string[1]) and (a_string[2] == w_string[2])) or \
            ((len(a_string)>2) and (len(a_string) > 1) and (a_string[1] == w_string[0]) and (a_string[2] == w_string[1])) or \
            ((len(w_string)>2) and (len(a_string) > 1) and (a_string[0] == w_string[1]) and (a_string[1] == w_string[2])):
            # Kontrola od začátku slovních tvarů.
            a_shift = 0
            for id_ch in range(0, max(len(w_string), len(a_string))):
                ...
                if not e_string[id_ch]: # OK
                    ...
                    if (id_ch < len(w_string)) and (id_cha < len(a_string) - 1):
                        ...
                        if (not e_string[id_ch]) and (id_ch==0) and (((w_string[0].lower() == "j") and (a_string[0].lower() == "j") and \
                            ((w_string[1] == a_string[0]) or (a_string[0].lower() == w_string[1].lower())) and (a_string[0] in list_consonnants)) or \
                            ((a_string[0].lower() == "j") and (w_string[0].lower() == "j") and ((w_string[0] == a_string[1]) or \
                            (w_string[0].lower() == a_string[1].lower())) and (a_string[1] in list_consonnants))):
                            if (w_string[0].lower() == "j"):
                                errors.append('formProtJ1')
                                e_string[id_ch+1]='J'
                                a_shift -= 1
        ...
        if this_condifition_satistified:
            ...
            if w_string[:allowed_tail_tolerence] == a_string[:allowed_tail_tolerence]:
                ...
                while w_string[tail_same_ind_w] == a_string[tail_same_ind_a]:
                    tail_same_ind_w -= 1
                    tail_same_ind_a -= 1
